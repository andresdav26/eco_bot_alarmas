...
from alarm_module.cardconnect import ConnectorCard
...
def auto_alarms():
    ...
    if bool(configs):
        ...
        logs_data, periodos = fetch_data(
            ...
            # period=["202201","202202","202203","202204"], 
            # period=["202205","202206","202207","202208"],
            # period=["202209","202210","202211","202212"],
        ...
        if bool(logs_data):
            ...
            for periodo in periodos: 
                    if periodo in df_logs_data.index:
                        ...
                        update_end = datetime.utcnow()
                        logger.warning(f'No se obtubieron datos de logs en el periodo {periodo}')
        else:
            update_end = datetime.utcnow() 
